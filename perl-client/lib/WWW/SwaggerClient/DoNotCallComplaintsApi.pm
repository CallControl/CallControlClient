...
#
package WWW::SwaggerClient::DoNotCallComplaintsApi;
...
sub do_not_call_complaints_do_not_call_complaints {
    ...
    unless (exists $args{'phone_number'}) {
      croak("Missing the required parameter 'phone_number' when calling do_not_call_complaints_do_not_call_complaints");
    }
    

    # parse inputs
    my $_resource_path = '/api/2015-11-01/DoNotCallComplaints/{phoneNumber}';
    ...
    my $_response_object = $self->{api_client}->deserialize('DoNotCallComplaints', $response);
