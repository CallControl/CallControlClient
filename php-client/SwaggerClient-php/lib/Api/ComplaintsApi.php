...
/**
 * ComplaintsApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
...
class ComplaintsApi
{
     ...
     * @return \Swagger\Client\Model\Complaints
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function complaintsComplaints($phone_number)
    {
        list($response, $statusCode, $httpHeader) = $this->complaintsComplaintsWithHttpInfo ($phone_number);
        return $response; 
    }
    ...
    public function complaintsComplaintsWithHttpInfo($phone_number)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams, '\Swagger\Client\Model\Complaints'
            );
